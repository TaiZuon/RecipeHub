package com.recipehub.ingredient_service.exception;
...
public enum ErrorCode {
    ...
    // Ingredient-related errors (8xxx)
    INGREDIENT_NOT_FOUND(8001, "Ingredient not found"),
    INGREDIENT_CREATION_FAILED(8002, "Failed to create ingredient"),
    INGREDIENT_UPDATE_FAILED(8003, "Failed to update ingredient"),
    INGREDIENT_DELETION_FAILED(8004, "Failed to delete ingredient"),
    INGREDIENT_OUT_OF_STOCK(8005, "Ingredient is out of stock"),
    INGREDIENT_ALREADY_LISTED(8006, "Ingredient is already listed for auction"),
    INGREDIENT_NOT_AVAILABLE(8007, "Ingredient is not available because ingredient is active"),
