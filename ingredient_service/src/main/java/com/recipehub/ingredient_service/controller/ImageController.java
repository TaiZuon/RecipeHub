...
import com.recipehub.ingredient_service.dto.response.PreSignedUrlResponse;
import com.recipehub.ingredient_service.service.ImageService;
...
public class ImageController {
    ...
    @PostMapping("/upload/ingredient/{ingredientId}")
    public ResponseEntity<List<String>> uploadIngredientImages(
            @PathVariable UUID ingredientId,
            @RequestParam("files") List<MultipartFile> files) {
        try {
            List<String> imageUrls = imageService.uploadIngredientImages(ingredientId, files);
