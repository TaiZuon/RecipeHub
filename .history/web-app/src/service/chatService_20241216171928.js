...
export const chatService = {
    ...
    getOrCreateRoom: async (otherUserId) => {
        try {
            const response = await axios.post('/api/chat/get-or-create-room', null, {
                params: { otherUserId }
            });
            return response.data;
        } catch (error) {
    ...
    deleteRoom: async (roomId) => {
        try {
            const response = await axios.delete(`/api/chat/room/${roomId}`);
            return response.data;
        } catch (error) {
    ...
    updateMessageStatus: async (roomId, messageIds, status) => {
        try {
            const response = await axios.post(`/api/chat/room/${roomId}/messages/status`, {
                messageIds,
                status
            });
            return response.data;
    ...
    sendMessage: async (roomId, message) => {
        try {
            const response = await axios.post(`/api/chat/room/${roomId}/message`, message);
            return response.data;
        } catch (error) {
