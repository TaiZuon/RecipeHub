...
export const Comments = ({ recipeId, userId, setShowLoginModal, comments, setComments }) => {
    ...
    const handleNewComment = async () => {
      if (!newComment.trim()) {
        alert("Please write something before sending your comment.");
        return;
      }
      if (!userId) {
  ...
  <div className="flex justify-end mt-3">
    <PrimaryButton
      type="button"
      className="rounded-md bg-blue-500 text-white px-4 py-2 hover:bg-blue-700"
        ...
        {comments.map((comment) => (
          ...
          >
            <div className="flex items-center">
              ...
              <Title level={6} className="font-normal p-3">{comment.userId}</Title>
