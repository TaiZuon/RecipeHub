...
import { chatService, getOrCreateRoom } from "../service/chatService";
...
const RecipeDetails = () => {
  ...
  const handleChatClick = async () => {
    try {
      const userId = localStorage.getItem("authUserId"); // Assuming you store the user ID in localStorage
      const room = await chatService.getOrCreateRoom(userId, creator.id);
