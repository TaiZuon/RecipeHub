package com.recipehub.recipe_service.exception;
...
public enum ErrorCode {
    ...
    // Recipe-related errors (8xxx)
    RECIPE_NOT_FOUND(8001, "Recipe not found"),
    RECIPE_CREATION_FAILED(8002, "Failed to create recipe"),
    RECIPE_UPDATE_FAILED(8003, "Failed to update recipe"),
    RECIPE_DELETION_FAILED(8004, "Failed to delete recipe"),
    RECIPE_OUT_OF_STOCK(8005, "Recipe is out of stock"),
