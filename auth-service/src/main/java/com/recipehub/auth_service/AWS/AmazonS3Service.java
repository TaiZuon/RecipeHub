package com.recipehub.auth_service.AWS;
...
import com.recipehub.auth_service.dto.response.PreSignedUrlResponse;
import com.recipehub.auth_service.exception.AppException;
import com.recipehub.auth_service.exception.ErrorCode;
...
public class AmazonS3Service {
    ...
    @Value("${DEFAULT_RECIPE_URL}")
    private String DEFAULT_RECIPE_URL;
